            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="{{ action('TeamController@index') }}">List of Teams</a>
                      <a class="dropdown-item" href="{{ action('TeamController@create') }}">Create a new Team</a>
                  </div>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="{{ action('UserController@index') }}">List of Users</a>
                  <a class="dropdown-item" href="{{ action('UserController@create') }}">Create a new User</a>
                </div>
              </li>
